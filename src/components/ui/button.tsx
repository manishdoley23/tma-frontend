    ...
    return (
      ...
      >
        {Icon && iconPlacement === "left" && (
          <div className="w-0 translate-x-[0%] pr-0 opacity-0 transition-all duration-200 group-hover/button:w-5 group-hover/button:translate-x-100 group-hover/button:pr-2 group-hover/button:opacity-100">
            <Icon />
          </div>
        )}
        <Slottable>{props.children}</Slottable>
        {Icon && iconPlacement === "right" && (
          <div className="w-0 translate-x-[100%] pl-0 opacity-0 transition-all duration-200 group-hover/button:w-5 group-hover/button:translate-x-0 group-hover/button:pl-2 group-hover/button:opacity-100">
            <Icon />
          </div>
        )}
      </Comp>
